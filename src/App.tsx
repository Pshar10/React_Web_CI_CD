...
function App() {
  ...
  const skills = [
    ...
    { name: 'Docker & Kubernetes', level: 90, icon: Server },
    { name: 'CI/CD', level: 90, icon: GitBranch },
    { name: 'Terraform', level: 80, icon: Cloud },
    { name: 'Databases', level: 75, icon: Database },
    { name: 'Security', level: 80, icon: Shield },
    { name: 'MATLAB', level: 85, icon: Code }
  ];
...
const projects = [
  {
    ...
    description: 'Built and Dockerized an AI chat agent enabling Ethereum Sepolia transactions. Deployed dockerized web app on AWS EC2 with automated Node.js and PNPM setup.',
  ...
  },
  {
    ...
    description: 'Web app for electricity usage analytics via data scraping with Selenium. Deployed with Django API, Docker, reverse proxy (NGINX), and ArgoCD.',
  ...
  },
  {
    ...
    description: 'Developed a novel DCNN model estimating decay parameters from reverberant speech signals with RMS errors of 2.9‑6 dB.',
    technologies: ['Deep Learning', 'Audio Processing', 'Python'],
    github: 'https://github.com/Pshar10/Blind-Estimation-of-EDC-from-Live-Signals'
  },
  {
    title: 'Spotify Trendz',
    subtitle: 'Real-Time Music Trend Analysis & DevOps Automation',
    description: 'This project automates real-time music trend analysis using Kubernetes and Terraform. Leveraged EKS for orchestration and Docker Swarm for container management, reducing deployment time by 40%. Integrated Prometheus and Grafana for monitoring.',
  ...
  },
  {
    ...
    description: 'A robust CI/CD pipeline for automating Spring Boot app deployment with Jenkins, Docker, Kubernetes, and ArgoCD, integrated with SonarQube for static code analysis.',
  ...
  },
  {
    ...
    description: 'A Dockerized microservice-based three-tier web app with a frontend (HTML, CSS, JS) and backend (Django), deployed on Kubernetes.',
  ...
  },
  {
    ...
    description: 'Developed and deployed an automated machine learning pipeline on AWS Elastic Beanstalk, integrating AWS CodePipeline and GitHub for CI/CD.',
  ...
  },
  {
    ...
    description: 'Two-tier web app for real-time contour detection and sensor control using Raspberry Pi and OpenCV, deployed with AWS Elastic Beanstalk and Docker.',
    technologies: ['Python', 'OpenCV', 'Raspberry Pi', 'AWS Elastic Beanstalk', 'Docker'],
    github: 'https://github.com/Pshar10/Web_Application_Countour_Detection_Using_Raspberrypi_And_Sensor_Controls'
  },
  {
    title: 'Video Processing',
    subtitle: 'Video Processing Utility',
    description: 'Python programs for video processing tasks including channel segregation, quantization, DCT, kernel filters, object detection, and pickling.',
  ...
  },
  {
    ...
    description: 'Implemented image retrieval from a large database based on visual content using machine learning.',
  ...
  },
  {
    ...
    description: 'Developed an arm-swinging locomotion game using HTC Vive, reducing dizziness by 60% to enhance VR user experience.',
  ...
  },
  {
    ...
    description: 'Mobile virtual loudspeaker using Binaural Room Impulse Response database and Intel RealSense depth camera, enhancing spatial audio on portable devices.',
  ...
  },
  {
    ...
    description: 'Python programs for advanced audio processing tasks: down/up sampling, filtering, quantization, low-delay filter-banks, pitch/speed enhancement, DCT, MDCT, and QMF.',
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ease-out ${
        scrollY > 50 ? 'bg-gray-900/95 backdrop-blur-md shadow-2xl border-b border-gray-800/50' : 'bg-transparent'
      }`}>
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="mb-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              AWS Certified Developer | DevOps Engineer | Audio Technology Expert
            </p>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
              Master's graduate bridging acoustic science and cloud engineering to drive innovation 
              in scalable, efficient systems with specialized expertise in spatial audio and DevOps automation.
            </p>
          </div>
          ...
          <div className="animate-bounce-slow animate-slide-up" style={{ animationDelay: '0.8s' }}>
            <ChevronDown 
              size={32} 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12" id="about-header">
            <h2 className={`text-4xl font-bold mb-4 text-white transition-all duration-1000 ${
              visibleElements.has('about-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>About Me</h2>
            <div className={`w-24 h-1 bg-gradient-to-r from-blue-400 to-emerald-400 mx-auto transition-all duration-1000 delay-200 ${
              visibleElements.has('about-header') ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
            }`}></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div id="about-content">
              <div className={`transition-all duration-1000 delay-300 ${
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Master's graduate in Media Technology with specialized expertise in spatial acoustics 
                  and cloud computing. I bring a unique perspective combining acoustic science with 
                  modern DevOps practices.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  With hands-on experience in building CI/CD pipelines, containerized deployments, 
                  and cloud-native systems, I'm passionate about automating infrastructure and 
            ...
            <div className="grid grid-cols-2 gap-6" id="about-certs">
              {certifications.map((cert, index) => (
                <div 
                  key={index} 
                  className={`bg-gray-700 p-6 rounded-lg hover:bg-gray-600 transition-all duration-500 transform hover:scale-105 hover:shadow-xl ${
                    visibleElements.has('about-certs') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                  style={{ transitionDelay: `${400 + index * 100}ms` }}
                >
                  <cert.icon className="text-blue-400 mb-3 transition-transform duration-300 hover:scale-110" size={24} />
      ...
      <section id="skills" className="py-20 bg-gray-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12" id="skills-header">
            <h2 className={`text-4xl font-bold mb-4 text-white transition-all duration-1000 ${
              visibleElements.has('skills-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>Technical Skills</h2>
            <div className={`w-24 h-1 bg-gradient-to-r from-blue-400 to-emerald-400 mx-auto transition-all duration-1000 delay-200 ${
              visibleElements.has('skills-header') ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
            }`}></div>
          </div>

          <div className="grid md:grid-cols-2 gap-8" id="skills-grid">
            {skills.map((skill, index) => (
              <div 
                key={index} 
                className={`bg-gray-800 p-6 rounded-lg hover:bg-gray-700 transition-all duration-500 transform hover:scale-105 hover:shadow-xl ${
                  visibleElements.has('skills-grid') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                style={{ transitionDelay: `${300 + index * 100}ms` }}
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <skill.icon className="text-blue-400 transition-transform duration-300 hover:scale-110" size={24} />
                ...
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div
                    className={`bg-gradient-to-r from-blue-400 to-emerald-400 h-2 rounded-full transition-all duration-2000 ease-out ${
                      visibleElements.has('skills-grid') ? '' : 'w-0'
                    }`}
                    style={{ 
                      width: visibleElements.has('skills-grid') ? `${skill.level}%` : '0%',
      ...
      <section id="experience" className="py-20 bg-gray-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12" id="experience-header">
            <h2 className={`text-4xl font-bold mb-4 text-white transition-all duration-1000 ${
              visibleElements.has('experience-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>Professional Experience</h2>
            <div className={`w-24 h-1 bg-gradient-to-r from-blue-400 to-emerald-400 mx-auto transition-all duration-1000 delay-200 ${
              visibleElements.has('experience-header') ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
            }`}></div>
          </div>

          <div className="space-y-8" id="experience-list">
            {experience.map((exp, index) => (
              <div 
                key={index} 
                className={`bg-gray-700 rounded-lg p-8 hover:bg-gray-600 transition-all duration-500 transform hover:scale-[1.02] hover:shadow-2xl ${
                  visibleElements.has('experience-list') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                ...
                <div className="space-y-3">
                  {exp.highlights.map((highlight, hIndex) => (
                    <div key={hIndex} className="flex items-start gap-3 group">
                      <div className="w-2 h-2 bg-emerald-400 rounded-full mt-2 flex-shrink-0 transition-transform duration-300 group-hover:scale-150"></div>
      ...
      <section id="projects" className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12" id="projects-header">
            ...
            <div className={`w-24 h-1 bg-gradient-to-r from-blue-400 to-emerald-400 mx-auto transition-all duration-1000 delay-200 ${
              visibleElements.has('projects-header') ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
            }`}></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8" id="projects-grid">
            {projects.map((project, index) => (
              <div
                key={index}
                className={`bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-all duration-500 group transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10 ${
                  visibleElements.has('projects-grid') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                style={{ transitionDelay: `${300 + index * 150}ms` }}
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold mb-1 text-white group-hover:text-blue-400 transition-colors duration-300">{project.title}</h3>
                    <p className="text-blue-400 font-semibold">{project.subtitle}</p>
                  </div>
                  <a
                    href={project.github}
                    className="p-2 text-gray-400 hover:text-white transition-all duration-300 transform hover:scale-110 hover:rotate-12"
                  >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-3 py-1 bg-gray-700 text-sm rounded-full text-gray-300 transition-all duration-300 hover:bg-blue-600 hover:text-white transform hover:scale-105"
                    >
                      {tech}
                    </span>
                  ))}
      ...
      <section id="contact" className="py-20 bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-12" id="contact-header">
            ...
            <div className={`w-24 h-1 bg-gradient-to-r from-blue-400 to-emerald-400 mx-auto mb-6 transition-all duration-1000 delay-200 ${
              visibleElements.has('contact-header') ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
            }`}></div>
            <p className={`text-gray-300 text-lg max-w-2xl mx-auto transition-all duration-1000 delay-400 ${
              visibleElements.has('contact-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              I'm always interested in discussing new opportunities, innovative projects, 
              and collaborations in DevOps, cloud computing, and audio technology.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-12" id="contact-cards">
            {[
              { icon: Mail, title: 'Email', subtitle: 'pshar416@gmail.com', href: 'mailto:pshar416@gmail.com', color: 'blue' },
              { icon: Linkedin, title: 'LinkedIn', subtitle: 'Connect with me', href: 'https://www.linkedin.com/in/pranav1010/', color: 'blue' },
              { icon: Github, title: 'GitHub', subtitle: 'View my code', href: 'https://github.com/Pshar10', color: 'emerald' }
            ].map((contact, index) => (
              <a
                key={index}
                href={contact.href}
                className={`flex flex-col items-center p-6 bg-gray-700 rounded-lg hover:bg-gray-600 transition-all duration-500 group transform hover:scale-105 hover:shadow-xl ${
                  visibleElements.has('contact-cards') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                style={{ transitionDelay: `${300 + index * 150}ms` }}
              >
                <contact.icon className={`text-${contact.color}-400 group-hover:text-${contact.color}-300 mb-3 transition-all duration-300 transform group-hover:scale-110`} size={32} />
                <h3 className="font-semibold mb-2 text-white group-hover:text-white transition-colors duration-300">{contact.title}</h3>
                <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">{contact.subtitle}</p>
              </a>
            ))}
          </div>
        </div>
      ...
      <footer className="bg-gray-900 border-t border-gray-700 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-400 transition-colors duration-300 hover:text-gray-300">
            © 2025 Pranav Sharma. Crafted with passion for innovation and excellence.
          </p>
        </div>
      </footer>
    </div>
